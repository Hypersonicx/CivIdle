export const DE = {
   ...
   AccountGreatPeopleLevelRequirement: "Benötigtes Herausragende Persönlichkeiten Level",
   ...
   AccountPlayTimeRequirement: "Benötigte Spielzeit",
   AccountRankUp: "Upgrade Account Rank",
   AccountRankUpDesc: "Der gesamte Fortschritt wird auf deinen neuen Rang übertragen",
   AccountRankUpTip: "Glückwunsch, dein Account ist für einen höheren Rang geeignet - bestätige hier zum upgraden!",
   ...
   AgeWisdomDescHTML: "Jedes Level von Altersweisheit bietet <b>an equivalent level</b> geeignete herausragenden Persönlichkeiten dieses Zeitalters - ein Upgrade kann mit geeigneten Scherben herausragender Persönlichkeiten durchgeführt werden",
   ...
   BatchSelectSameTypeSameLevel: "Gleicher Typ Gleiches Level",
   ...
   BritishMuseumChooseWonder: "Wähle ein Wunder",
   BritishMuseumDesc: "Nach dem Bau kann es sich in ein einzigartiges Wunder aus anderen Zivilisationen verändern.",
   BritishMuseumTransform: "Verändern",
   Broadway: "Broadway",
   ...
   CambridgeUniversityDesc: "+1 Stufe Altersweisheits für Renaissance und alle Zeitalter danach",
   ...
   CerneAbbasGiantDesc: "Eine herausragende Persönlichkeit der heutigen Zeit wird geboren, wenn ein Wunder gebaut wird",
